...
# trace_from_test_class(TestMessageAPI, ['email.message'], report_format='html', report_dir='TestMessageAPI')


# from test.test_email import test_email
# trace_from_test_module(test_email, ['email'], report_format='html', report_dir='test_email')
...
trace_from_test_module(test_ast, ['ast'], report_format='html', report_dir='ast2')


# from test import test_gzip
# trace_from_test_module(test_gzip, ['gzip'], report_format='html', report_dir='gzip2')
