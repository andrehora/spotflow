...
class TestLocalMethodCall(unittest.TestCase):
    ...
    def test_has_local_method_2(self):
        ...
        calls = result['tests.stub_sut.LocalMethod.has_local_method_2'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [340, 341, 343, 346, 347])

        calls = result['tests.stub_sut.LocalMethod.has_local_method_2.<locals>.local_method'].calls
    ...
    def test_has_local_method_3(self):
        ...
        calls = result['tests.stub_sut.LocalMethod.has_local_method_3'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [350, 351, 353, 356, 359, 360])

        calls = result['tests.stub_sut.LocalMethod.has_local_method_3.<locals>.local_method_1'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [354])

        calls = result['tests.stub_sut.LocalMethod.has_local_method_3.<locals>.local_method_2'].calls
        self.assertEqual(len(calls), 1)
    ...
    def test_has_local_method_4(self):
        ...
        calls = result['tests.stub_sut.LocalMethod.has_local_method_4'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [363, 364, 366, 374])

        calls = result['tests.stub_sut.LocalMethod.has_local_method_4.<locals>.local_method_1'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [368, 371, 372])

        # Very nested case
        calls = result['tests.stub_sut.LocalMethod.has_local_method_4.<locals>.local_method_1.<locals>.local_method_2'].calls
        self.assertEqual(len(calls), 1)
...
class TestLocalFunctionCall(unittest.TestCase):
    ...
    def test_has_local_function_2(self):
        ...
        calls = result['tests.stub_sut.has_local_function_2'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [386, 387, 389, 392, 393])

        calls = result['tests.stub_sut.has_local_function_2.<locals>.local_function'].calls
        self.assertEqual(len(calls), 2)
    ...
    def test_has_local_function_3(self):
        ...
        calls = result['tests.stub_sut.has_local_function_3'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [397, 398, 400, 403, 406, 407])

        calls = result['tests.stub_sut.has_local_function_3.<locals>.local_function_1'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [401])

        calls = result['tests.stub_sut.has_local_function_3.<locals>.local_function_2'].calls
        self.assertEqual(len(calls), 1)
    ...
    def test_has_local_function_4(self):
        ...
        calls = result['tests.stub_sut.has_local_function_4'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [411, 412, 414, 422])

        calls = result['tests.stub_sut.has_local_function_4.<locals>.local_function_1'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [416, 419, 420])

        # Very nested case
        calls = result['tests.stub_sut.has_local_function_4.<locals>.local_function_1.<locals>.local_function_2'].calls
        self.assertEqual(len(calls), 1)
