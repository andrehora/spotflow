...
class TestComprehensionFlow(unittest.TestCase):
    ...
    def test_listcomp_1(self):
        target_method_name = 'tests.stub_sut.Comprehension.listcomp_1'
        ...
        self.assertEqual(flows[0].distinct_run_lines(), [315])

    def test_listcomp_2(self):
        target_method_name = 'tests.stub_sut.Comprehension.listcomp_2'
        ...
        self.assertEqual(flows[0].distinct_run_lines(), [318])

    def test_setcomp_1(self):
        target_method_name = 'tests.stub_sut.Comprehension.setcomp_1'
        ...
        self.assertEqual(flows[0].distinct_run_lines(), [321])

    def test_setcomp_2(self):
        target_method_name = 'tests.stub_sut.Comprehension.setcomp_2'
        ...
        self.assertEqual(flows[0].distinct_run_lines(), [324])

    def test_dictcomp(self):
        target_method_name = 'tests.stub_sut.Comprehension.dictcomp'
        ...
        self.assertEqual(flows[0].distinct_run_lines(), [327])
