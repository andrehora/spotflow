...
class TestSuperCall(unittest.TestCase):
    ...
    def test_super_init_a(self):
        ...
        calls = result['tests.stub_sut.ClassA.__init__'].calls
    ...
    def test_super_init_b(self):
        ...
        calls = result['tests.stub_sut.ClassB.__init__'].calls
        self.assertEqual(len(calls), 1)
    ...
    def test_super_init_c(self):
        ...
        calls = result['tests.stub_sut.ClassC.__init__'].calls
        self.assertEqual(len(calls), 1)
    ...
    def test_super_init_d(self):
        ...
        calls = result['tests.stub_sut.ClassD.__init__'].calls
        self.assertEqual(len(calls), 1)
    ...
    def test_super_foobar_b(self):
        ...
        calls = result['tests.stub_sut.ClassB.foobar'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [442, 443, 444])

        calls = result['tests.stub_sut.ClassA.foobar'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [432])
    ...
    def test_super_foobar_c(self):
        ...
        calls = result['tests.stub_sut.ClassC.foobar'].calls
        self.assertEqual(len(calls), 1)
...
class TestMoreSuperCall(unittest.TestCase):
    ...
    def test_super_1(self):
        ...
        calls = result['tests.stub_sut.ClassSuper1.__init__'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [505, 506, 507])

        calls = result['tests.stub_sut.ClassSuper1.foobar'].calls
        self.assertEqual(len(calls), 1)
    ...
    def test_super_2(self):
        ...
        calls = result['tests.stub_sut.ClassSuper2.__init__'].calls
        self.assertEqual(len(calls), 1)
    ...
    def test_super_3(self):
        ...
        calls = result['tests.stub_sut.ClassSuper3.foobar'].calls
        self.assertEqual(len(calls), 1)
...
class TestOverrideCall(unittest.TestCase):
    ...
    def test_override_show(self):
        ...
        calls = result['tests.stub_sut.OverrideShow.show'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [484])

        calls = result['tests.stub_sut.BaseClass.main'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [472])
    ...
    def test_override_main(self):
        ...
        calls = result['tests.stub_sut.OverrideMain.main'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [490])

        calls = result['tests.stub_sut.BaseClass.report'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [478])
    ...
    def test_override_main_and_report(self):
        ...
        calls = result['tests.stub_sut.OverrideMainAndReport.main'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [496])

        calls = result['tests.stub_sut.OverrideMainAndReport.report'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [499])

        calls = result['tests.stub_sut.BaseClass.show'].calls
        self.assertEqual(len(calls), 1)
        self.assertEqual(calls[0].run_lines, [475])
