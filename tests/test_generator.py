...
class TestGeneratorFlow(unittest.TestCase):
    ...
    def test_no_generator(self):
        target_method_name = 'tests.stub_sut.Generators.no_generator'
    ...
    def test_call_generator_1(self):
        target_method_name1 = 'tests.stub_sut.Generators.call_generator_1'
        target_method_name2 = 'tests.stub_sut.Generators.has_generator_1'
        func = TestGenerator().test_call_generator_1

        result = run_and_flow_func(func, [target_method_name1, target_method_name2])

        self.assertEqual(len(result), 2)

        flows = result[target_method_name1].calls
        self.assertEqual(len(flows), 1)
        self.assertEqual(flows[0].run_lines, [261, 262])

        flows = result[target_method_name2].calls
        self.assertEqual(len(flows), 1)
    ...
    def test_call_generator_2(self):
        target_method_name1 = 'tests.stub_sut.Generators.call_generator_2'
        target_method_name2 = 'tests.stub_sut.Generators.has_generator_2'
    ...
    def test_call_generator_3(self):
        target_method_name1 = 'tests.stub_sut.Generators.call_generator_3'
        target_method_name2 = 'tests.stub_sut.Generators.has_generator_3'
    ...
    def test_call_generator_4(self):
        target_method_name1 = 'tests.stub_sut.Generators.call_generator_4'
        target_method_name2 = 'tests.stub_sut.Generators.has_generator_4'
    ...
    def test_has_generator_1(self):
        target_method_name = 'tests.stub_sut.Generators.has_generator_1'
    ...
    def test_has_generator_2(self):
        target_method_name = 'tests.stub_sut.Generators.has_generator_2'
    ...
    def test_has_generator_3(self):
        target_method_name = 'tests.stub_sut.Generators.has_generator_3'
    ...
    def test_has_generator_4(self):
        target_method_name = 'tests.stub_sut.Generators.has_generator_4'
    ...
    def test_generators_all(self):
        target_method_name = 'tests.stub_sut.Generators'
...
class TestGeneratorExpressionFlow(unittest.TestCase):
    ...
    def test_generator_expression_1(self):
        target_method_name = 'tests.stub_sut.GeneratorExpression.generator_expression_1'
    ...
    def test_generator_expression_2(self):
        target_method_name = 'tests.stub_sut.GeneratorExpression.generator_expression_2'
