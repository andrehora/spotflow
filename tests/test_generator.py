...
class TestGenerator(unittest.TestCase):
    ...
    def test_call_generator_4(self):
        ...
        trace_result = TraceRunner.trace_from_tests('tests.stub_test.TestGenerators.test_call_generator_4', [target_entity_name1, target_entity_name2])
        self.assertEqual(len(trace_result), 2)
    ...
    def test_has_generator_4(self):
        ...
        trace_result = TraceRunner.trace_from_tests('tests.stub_test.TestGenerators.test_has_generator_4', [target_entity_name])
        self.assertEqual(len(trace_result), 1)
    ...
    def test_generators_all(self):
        ...
        self.assertEqual(len(trace_result), 9)
