...
class TestGlobalFlowSUTMethod(unittest.TestCase):
    ...
    def test_run_simple_if(self):
        ...
        self.assertIn('test_simple_if_true', flow_result.source_names)
        ...
        self.assertEqual(flow_result.sut_name, 'simple_if')
        self.assertIn('test_simple_if_false', flow_result.source_names)
    ...
    def test_run_simple_if_else(self):
        ...
        self.assertIn('test_simple_if_else_true_and_false', flow_result.source_names)
        ...
        self.assertEqual(flow_result.sut_name, 'simple_if_else')
        self.assertIn('test_simple_if_else_true', flow_result.source_names)
        ...
        self.assertEqual(flow_result.sut_name, 'simple_if_else')
        self.assertIn('test_simple_if_else_false', flow_result.source_names)
    ...
    def test_run_loop(self):
        ...
        self.assertIn('test_loop', flow_result.source_names)
    ...
    def test_run_try(self):
        ...
        self.assertIn('test_try_success', flow_result.source_names)
    ...
    def test_run_try_fail(self):
        ...
        self.assertIn('test_try_fail', flow_result.source_names)
    ...
    def test_single_call_to_sut(self):
        ...
        self.assertIn('test_single_call_to_sut_bom_dia', flow_result.source_names)
        ...
        self.assertEqual(flow_result.sut_name, 'hello')
        self.assertIn('test_single_call_to_sut_boa_tarde', flow_result.source_names)
        ...
        self.assertEqual(flow_result.sut_name, 'hello')
        self.assertIn('test_single_call_to_sut_boa_noite', flow_result.source_names)
    ...
    def test_multiple_call_to_sut(self):
        ...
        self.assertEqual(flow_result.sut_name, 'hello')
        self.assertIn('test_multiple_call_to_sut', flow_result.source_names)
...
class TestLocalFlowSUTMethod(unittest.TestCase):
    ...
    def test_sut_call_sut(self):
        ...
        self.assertIn('test_sut_call_sut', flow_result.source_names)
...
class TestLocalFlowSUTClass(unittest.TestCase):
    ...
    def test_sut_class_SimpleFlow(self):
        ...
        self.assertEqual(flow_result.number_of_sources(), 9)
    ...
    def test_sut_class_ComplexFlow(self):
        ...
        self.assertEqual(flow_result.number_of_sources(), 10)
