...
class TestArgAndReturnValue(unittest.TestCase):
    ...
    def test_simple_return_local(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_simple_return_local', sut)
    ...
    def test_simple_return_global(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_simple_return_global', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_simple_return_with_arg(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_simple_return_with_arg', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_return_0(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_return_0', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_return_1(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_return_1', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_return_2(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_return_2', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_return_3(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_return_3', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_return_4(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_return_4', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_return_5(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_return_5', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_multiple_return_true(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_multiple_return_true', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_multiple_return_false(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_multiple_return_false', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_attribute_0(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_attribute_0', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_attribute_1(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_attribute_1', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_attribute_2(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_attribute_2', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_attribute_3(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_attribute_3', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_obj_1(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_obj_1', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_obj_2(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_obj_2', sut)
        flow_result = sut.local_flows(trace_result)
    ...
    def test_change_obj_3(self):
        ...
        trace_result = TraceRunner.trace_tests('stub_test.TestReturnValue.test_change_obj_3', sut)
        flow_result = sut.local_flows(trace_result)
