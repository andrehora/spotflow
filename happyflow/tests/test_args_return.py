...
class TestArgAndReturnValue(unittest.TestCase):
    ...
    def test_simple_return_with_arg(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.simple_return_with_arg')
    ...
    def test_change_return_0(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_return_0')
    ...
    def test_change_return_1(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_return_1')
    ...
    def test_change_return_2(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_return_2')
    ...
    def test_change_return_3(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_return_3')
    ...
    def test_change_return_4(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_return_4')
    ...
    def test_change_return_5(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_return_5')
    ...
    def test_multiple_return_true(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.multiple_return')
    ...
    def test_change_attribute_0(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_attribute_0')
    ...
    def test_change_attribute_1(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_attribute_1')
    ...
    def test_change_attribute_2(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_attribute_2')
    ...
    def test_change_attribute_3(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_attribute_3')
    ...
    def test_change_obj_1(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_obj_1')
    ...
    def test_change_obj_2(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_obj_2')
    ...
    def test_change_obj_3(self):
        sut = SUTLoader.find_sut('stub_sut.ReturnValue.change_obj_3')
