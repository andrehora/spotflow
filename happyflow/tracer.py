...
import inspect
import logging
from happyflow.utils import copy_or_type, full_name_from_frame, line_has_explicit_return, find_callers
...
class TraceCollector:
    ...
    def ensure_target_entity(self, current_entity_name, target_entity, frame):
        ...
        entity = TargetEntity.build_from_frame(frame)
    ...
    def collect_flow_and_state(self, frame, why, arg):
        ...
        current_entity_name = full_name_from_frame(frame)
                ...
                if target_entity and current_entity_name == target_entity.full_name:
                    ...
                    # why in ('line', 'return', 'exception')
                        ...
                        if why == 'line':
                            ...
                            current_state_result.return_state = ReturnState(copy_or_type(arg), lineno, has_return)
                        else:
                            # why == 'exception':
